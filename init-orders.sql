CREATE DATABASE demo_00_orders CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
INSERT INTO orders (order_no, product_name, quantity, price, create_time)
SELECT
    CONCAT('ORD-', LPAD(n, 5, '0'))              AS order_no,
    CONCAT('Product-', n)                        AS product_name,
    FLOOR(1 + (RAND() * 10))                     AS quantity,
    ROUND(10 + (RAND() * 990), 2)                AS price,
    NOW() - INTERVAL FLOOR(RAND() * 30) DAY      AS create_time
FROM (
